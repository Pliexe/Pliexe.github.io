...
interface IOptions {
    ...
    atmosphereColor?: { r: number, g: number, b: number, o: number };
    ...
    constructor(scene: Three.Scene, options: IOptions) {
        this.planet = new Three.Mesh(
            ...
            new Three.ShaderMaterial({
                ...
                uniforms: {
                    globeAtmosphere: {
                        value: options.atmosphereColor == undefined ? new Three.Vector3(0.3, 0.6, 1.0) : new Three.Vector3(options.atmosphereColor.r, options.atmosphereColor.g, options.atmosphereColor.b)
                    },
                    globeTexture: {
        ...
        this.atmosphere = new Three.Mesh(
            ...
            new Three.ShaderMaterial({
                ...
                uniforms: {
                    globeAtmosphere: {
                        value: options.atmosphereColor == undefined ? new Three.Vector4(0.3, 0.6, 1.0, 1.0) : new Three.Vector4(options.atmosphereColor.r, options.atmosphereColor.g, options.atmosphereColor.b, options.atmosphereColor.o)
                    },
                    atmosphereIntensity: {
